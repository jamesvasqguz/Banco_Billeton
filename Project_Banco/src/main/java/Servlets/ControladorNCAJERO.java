 ...
 * @author jara
 */
@WebServlet(name = "ControladorNCAJERO", urlPatterns = {"/ControladorNCAJERO"})
public class ControladorNCAJERO extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cons.verificarEmpleado(dpi, rol)) {
            String msj = "Ya existe un Cajero con el mismo dpi.";
            System.out.println("Cajero no se ingreso");
            ...
            if ((ins.crearEmpleado(nombre, turno, rol, dpi, direccion, sexo))) {
                ...
                System.out.println("Cajero ingresado correctamente");
                sesion.setAttribute("msj", msj);
                sesion.setAttribute("codigoCL", codigo);
                response.sendRedirect("JSP/OperacionExitosa.jsp");
            } else {
                String msj = "Error al ingresar el Cajero, revisa los datos que ingresaste ";
                System.out.println("Cajero no se ingreso");
                sesion.setAttribute("Error", msj);
                response.sendRedirect("JSP/OperacionFallida.jsp");
            }
