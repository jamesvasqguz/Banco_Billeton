        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorFijarL">
                        <div class="form-group text-center">
                            <h1 class="text-light">Fijar Limites</h1>
                            <img src="../Imagenes/estadisticas1.svg" width="100px"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Limite 1</label>
                            <input type="number" name="lim1" class="form-control" placeholder="Limite 1" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Limite 2</label>
                            <input type="number" name="lim2" class="form-control" placeholder="Limite 2" required="Campo Obligatorio"/>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="form-group mx-sm-4 pt-3">
