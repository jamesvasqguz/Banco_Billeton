...
<html>
    ...
    <body>
        <%
            ...
            ArrayList<Cajero> listar = act.datosCajero(codigo);
        %>
            ...
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    ...
                    <div class="form-group mx-sm-4 pt-3">
                        <label>Nombre</label>
                        <input type="text" name="nombre" value="<%=ca.getNombre()%> "class="form-control" readonly/>
                    </div>
                    <div class="form-group mx-sm-4 pt-3">
                        <label>Turno del Cajero</label>
                        <input type="text" name="turno" value="<%=ca.getTurno()%> "class="form-control" readonly/>
                    </div>
                    <div class="form-group mx-sm-4 pt-3">
                        <label>DPI</label>
                        <input type="text" name="dpi" value="<%=ca.getDpi()%>" class="form-control" readonly/>
                    </div>
                    <div class="form-group mx-sm-4 pt-3">
                        <label>Direccion</label>
                        <input type="text" name="direccion" value="<%=ca.getDireccion()%>" class="form-control" readonly/>
                    </div>
                    <div class="form-group mx-sm-4 pt-3">
                        <label>Sexo</label>
                        <input type="text" name="sexo" value="<%=ca.getSexo()%>" class="form-control" readonly/>
                    </div>
                    <%       }
                        }
                    %>
