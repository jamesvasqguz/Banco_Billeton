...
<html>
    ...
    <body>
        <%
            ...
            ArrayList<Gerente> listar = act.datosGerente(codigo);
        %>
        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorActualizarInfo">
                        <div class="form-group text-center">
                            <h1 class="text-light">Mi Informacion</h1>
                            <img src="../Imagenes/edit-user.png" width="100px"/>
                        </div>
                        <%           if (listar.size() > 0) {
                                for (Gerente g : listar) {
                                    ge = g;
                        %> 
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Nombre</label>
                            <input type="text" name="nombre" value="<%=ge.getNombre()%> "class="form-control" placeholder="Nombre Completo" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Turno del GERENTE</label>
                            <br>
                            <input type="text" name="turno"  value="<%=ge.getTurno()%>" placeholder="Turno" list="Turnos" required="Campo Obligatorio">
                            <datalist id="Turnos">
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            <label>DPI</label>
                            <input type="text" name="dpi" value="<%=ge.getDpi()%>" class="form-control" placeholder="DPI del Gerente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Direccion</label>
                            <input type="text" name="direccion" value="<%=ge.getDireccion()%>" class="form-control" placeholder="Direccion del Gerente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Sexo</label>
                            <br>
                            <input type="text" name="sexo" value="<%=ge.getSexo()%>" placeholder="Sexo" list="Sexo" required="Campo Obligatorio">
                            <datalist id="Sexo">
                                <option value="M">
                                <option value="F">
                            </datalist>
                        ...
                        <div class="form-group mx-sm-4 pt-2">
                            <input type="submit" class="btn btn-block btn-light " value="Modificar"/>
                        </div>
                    </form>
                </div>
            </div>
