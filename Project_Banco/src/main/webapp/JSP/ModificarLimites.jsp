        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorActuL">
                        <div class="form-group text-center">
                            <h1 class="text-light">Modificar Limites</h1>
                            <img src="../Imagenes/edit-outline.svg" width="100px"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Limite 1</label>
                            <input type="number" name="lim1" class="form-control" min="1" max="100" step="1" placeholder="Limite 1" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Limite 2</label>
                            <input type="number" name="lim2" class="form-control" min="1" max="100" step="1" placeholder="Limite 2" required="Campo Obligatorio"/>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Recuerde: Limite 2 debe ser mayor a Limite 1.</label>
                        </div>
                        <div class="form-group mx-sm-4 pt-2">
                            <input type="submit" class="btn btn-block btn-light " value="Fijar Limites"/>
                        </div>
                    </form>
                </div>
            </div>
