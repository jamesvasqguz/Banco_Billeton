        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorCuenta">
                        <div class="form-group text-center">
                            <h1 class="text-light">Crear Cuenta Bancaria</h1>
                            <img src="../Imagenes/lista.svg" width="100px"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Codigo del Cliente</label>
                            <input type="text" name="cliente" class="form-control" placeholder="Codigo del Cliente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Saldo de Apertura</label>
                            <input type="text" name="saldo" class="form-control" placeholder="Monto inicial" required="Campo Obligatorio"/>
                        </div>
                        <div class="dropdown-divider"></div>
