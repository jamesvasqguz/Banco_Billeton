        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorNCLIENTE">
                        <div class="form-group text-center">
                            <h1 class="text-light">Nuevo Cliente</h1>
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            <label>DPI</label>
                            <input type="text" name="dpi" class="form-control" placeholder="DPI del Cliente" required="Campo Obligatorio"/>
                        </div> 
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Fecha Nacimiento</label>
                            <input type="date" name="fecha" class="form-control" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Direccion</label>
                            <input type="text" name="direccion" class="form-control" placeholder="Direccion del Cliente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Sexo</label>
                            <br>
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Archivo DPI</label>
                            <input type="file" name="filedpi" class="form-control" required="Campo Obligatorio"/>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="form-group mx-sm-4 pt-3">
