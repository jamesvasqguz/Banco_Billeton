        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorNGERENTE">
                        <div class="form-group text-center">
                            <h1 class="text-light">Nuevo Gerente</h1>
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            <label>DPI</label>
                            <input type="text" name="dpi" class="form-control" placeholder="DPI del Gerente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Direccion</label>
                            <input type="text" name="direccion" class="form-control" placeholder="Direccion del Gerente" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Sexo</label>
                            <br>
