        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorNU">
                        <div class="form-group text-center">
                            <h1 class="text-light">Nuevo Usuario</h1>
                            <img src="../Imagenes/edit-user.png" width="100px"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Codigo Unico</label>
                            <input type="text" name="codigo" class="form-control" placeholder="Ingrese Codigo Unico" required="Campo Obligatorio"/>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Seleccione rol del Usuario</label>
                            <br>
                            <input type="text" name="rol" placeholder="Roles" list="roles">
                            <datalist id="roles">
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            ...
                            <input type="password" name="pass" class="form-control" placeholder="Ingrese la Contraseña" required="Campo Obligatorio"/>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>El usuario para ingresar al sistema se le dara a continuacion.</label>
                        </div>
