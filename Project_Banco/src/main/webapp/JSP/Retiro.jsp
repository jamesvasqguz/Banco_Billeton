        ...
        <div class="container">
            <div class="row justify-content-center pt-5 mt-5 mr-1">
                <div class="col-md-4 registros">
                    <form method="POST" action="/Project_Banco/ControladorRetiro">
                        <div class="form-group text-center">
                            <h1 class="text-light">Realizar Retiro</h1>
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            ...
                            <br>
                            <label>Verificar el DPI del cliente</label>
                            <a href="verificarPDF.jsp" target="_blank"><img src="../Imagenes/periodico.svg" width="100px"/></a>
                        </div>
                        <div class="form-group mx-sm-4 pt-3">
                            <label>Monto</label>
                        ...
                        <div class="form-group mx-sm-4 pt-3">
                            <div class="alert alert-warning" role="alert">
                                Recuerde verificar el DPI del cliente.
                            </div>
                        </div>
                        <div class="dropdown-divider"></div>
                        <div class="form-group mx-sm-4 pt-2">
                            <input type="submit" class="btn btn-block btn-light " value="Retirar"/>
                        </div>
                    </form>
                </div>
            </div>
